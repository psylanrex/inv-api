...
use App\Services\Items\DeleteItems\Watches\DeleteOldWAtchRecordsService;
use App\Services\Items\SaveItems\ComplexItems\Watches\TransactionServices\RecordAttributesForMaterial;

class UpdateWatchTransactionService
{
    ...
    public function updateItemTransaction($request)
    {
        ...
        try{
           ...
           (new DeleteOldWAtchRecordsService)->deleteOldWatchRecords($product_id);
            ...
            // create records for watch attributes
